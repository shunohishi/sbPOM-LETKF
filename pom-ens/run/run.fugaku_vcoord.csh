...
set REGION=test
set EXE=pom.exe
set DIR0=/data/hp120279/u00399/TEST/pom-ens
set TIDEDIR=${DIR0}/TIDE
set NCDIR=/data/hp120279/u00399/TEST/prep/in
set CURDIR=`pwd`
set EPROC=48 #Each processor
set MEMBER=70 #Number of ensemble
...
#PJM --name "sbPOM_${REGION}_${year}${month}"
#PJM -s
#
...
#------------------------------------------------
	...
	${compiler} ens/mesp_ens.f90 -o mesp_ens_${year}${month}.out ${option}

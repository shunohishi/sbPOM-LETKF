...
mpiexec -n ${PROC} -stdout stdout.${REGION} -stderr stderr.${REGION} ./${PROG}

echo finished > FINISHED_sbPOM
...
while(${IMEM} <= ${MEMBER})
    ...
    if(-f ${MEM}/sbPOM_${REGION}_${yyyy1}${mm1}${dd1}_${MEM}.*.stats)then
	(mv -f ${MEM}/sbPOM_${REGION}_${yyyy1}${mm1}${dd1}_${MEM}.*.stats ${INFO}/ &)
    else
	echo "Not Found ${MEM}/sbPOM_${REGION}_${yyyy1}${mm1}${dd1}_${MEM}.*.stats"
    endif

    (rm -f ${MEM}/sbPOM_${REGION}_${yyyy1}${mm1}${dd1}_${MEM}.*.out &)
    (rm -f ${MEM}/sbPOM_${REGION}_${yyyy1}${mm1}${dd1}_${MEM}.*.err &)

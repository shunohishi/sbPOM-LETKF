...
while(${IMEM} <= ${MEMBER})
    ...
    (mv -f ${MEM}/sbPOM_${REGION}_${yyyy1}${mm1}${dd1}_iau${MEM}.*.stats ${INFO}/ &)
    (rm -f ${MEM}/sbPOM_${REGION}_${yyyy1}${mm1}${dd1}_iau${MEM}.*.out &)
    (rm -f ${MEM}/sbPOM_${REGION}_${yyyy1}${mm1}${dd1}_iau${MEM}.*.err &)

...
#JX -N sbPOM_${REGION}_${yyyy1}${mm1}${dd1}
#JX -S
...
while(${IMEM} <= ${MEMBER})
    ...
    if(-s sbPOM_${REGION}_${yyyy1}${mm1}${dd1}${JOBID}.stats)then
	(mv -f sbPOM_${REGION}_${yyyy1}${mm1}${dd1}${JOBID}.stats ${INFO}/ &)
    else
	(rm -f sbPOM_${REGION}_${yyyy1}${mm1}${dd1}${JOBID}.stats &)
    endif

    (rm -f sbPOM_${REGION}_${yyyy1}${mm1}${dd1}${JOBID}.out &)
    (rm -f sbPOM_${REGION}_${yyyy1}${mm1}${dd1}${JOBID}.err &)
